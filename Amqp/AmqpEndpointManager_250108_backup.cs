...
//		//				.Select(p =>
//		//				{
//		//					var genericParam = (GenericParameter)p; // 在 Select 中重新轉換類型
//		//					var value = genericParam.Value;
//		//					Console.WriteLine($"解析參數: {genericParam.Name}, 值: {value}");

//		//					// 嘗試將值轉換為 byte
//		//					if (byte.TryParse(value.ToString(), out var station))
//		//					{
...
//		//					else
//		//					{
//		//						Console.WriteLine($"站號轉換失敗: {value}");
//		//						return null;
//		//					}
//		//				})
//		//				.Where(p => p.HasValue)
...
//					bool hasProcessed = false; // 标记是否处理了任何参数
