...
//			InitializeModbusTcpClient();
//		}

//		private void InitializeModbusTcpClient()
//		{
//			try
//			{
...
//		// 其餘代碼保持不變，將 SerialPort 替換為 master (IModbusMaster)
//	}
...
//		//public async Task StartAmqpEndpointAsync(string endpointName)
//		//{
//		//	if (string.IsNullOrEmpty(endpointName))
//		//		throw new ArgumentException("Endpoint name cannot be null or empty", nameof(endpointName));
...
//		//	{
//		//		Dictionary<byte, int> lastStatus = new Dictionary<byte, int>();
//		//		DateTime lastEnergyPublishTime = DateTime.MinValue;
