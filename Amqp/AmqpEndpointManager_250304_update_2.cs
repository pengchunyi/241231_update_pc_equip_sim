		...
		private static readonly Dictionary<int, (string Code, string ErrorDescription)> faultDictionary = new Dictionary<int, (string Code, string ErrorDescription)>
{
	...
	{ 8, ("EGY_1_ERR9", "C相過流") },
	{ 9, ("EGY_1_ERR10", "漏電異常") },
	{ 10, ("EGY_1_ERR11", "A相出線溫度異常") },
	{ 11, ("EGY_1_ERR12", "B相出線溫度異常") },
	{ 12, ("EGY_1_ERR13", "C相出線溫度異常") },
	{ 13, ("EGY_1_ERR14", "N相出線溫度異常") },
	{ 14, ("EGY_1_ERR15", "電弧") },
	{ 15, ("EGY_1_ERR16", "缺相") },
	{ 16, ("EGY_1_ERR17", "斷零") },
	{ 17, ("EGY_1_ERR18", "三相電壓不平衡") },
	{ 18, ("EGY_1_ERR19", "鎖定") },
	{ 19, ("EGY_1_ERR20", "進入維修或手動模式") },
	{ 20, ("EGY_1_ERR21", "開關狀態異常，提示客戶換設備") },
	{ 21, ("EGY_1_ERR22", "漏電功能壞，提示客戶換設備") },
	{ 22, ("EGY_1_ERR23", "設備離線") },
	{ 23, ("EGY_1_ERR24", "過壓預警") },
	{ 24, ("EGY_1_ERR25", "欠壓預警") },
	{ 25, ("EGY_1_ERR26", "過流預警") },
	{ 26, ("EGY_1_ERR27", "過溫預警") }
			...
			try
			{
				if (request.MessageBody is ModifyStationParametersRequest modifyRequest)
				{
					...
					foreach (var parameter in modifyRequest.NewParameters)
					{
						...
						{
							// 處理保護溫度
							if (genericParam.Name == "Temperature Protection" && ushort.TryParse(genericParam.Value.ToString(), out var temperature))
							{
		...
		private void PublishStationParametersModifiedMessages(byte stationNumber, AmqpCFXEndpoint endpoint)
		{
			...
			if (data.ContainsKey("PowerTemperatureA") || data.ContainsKey("PowerTemperatureB") || data.ContainsKey("PowerTemperatureC"))
			{
				maxTemperature = new[]
				{
			data.ContainsKey("PowerTemperatureA") ? data["PowerTemperatureA"] : 0,
			data.ContainsKey("PowerTemperatureB") ? data["PowerTemperatureB"] : 0,
			data.ContainsKey("PowerTemperatureC") ? data["PowerTemperatureC"] : 0
		}.Max();
			}
			...
			var parameters = new List<Parameter>
	{
		...
		{
			Name = "PowerSwitch",
			Value = data.ContainsKey("PowerSwitch") ? data["PowerSwitch"].ToString() : "0"
		},
		// 三相溫度
		new GenericParameter
		{
