...
//		//20241206_新增_處理遠端溫度設定=================================================
//		// 新增的處理請求邏輯
//		private async Task HandleModifyStationParametersRequest(ModifyStationParametersRequest request, AmqpCFXEndpoint endpoint)
//		{
//			try
//			{
...
//				// 檢查參數是否存在並有效
//				if (request.NewParameters == null || !request.NewParameters.Any())
//				{
//					await RespondWithFailure(endpoint, "參數列表為空或無效。");
//					return;
//				}

//				// 遍歷參數並處理
//				foreach (var parameter in request.NewParameters)
//				{
...
//						{
//							Console.WriteLine($"成功解析保護溫度: {temperature}°C");
...
//						else
//						{
//							await RespondWithFailure(endpoint, $"無效的溫度值: {genericParam.Value}");
//							return;
//						}
//					}
//					else
//					{
//						await RespondWithFailure(endpoint, $"不支援的參數: {parameter.GetType().Name}");
//						return;
//					}
//				}

//				// 回應成功
//				await RespondWithSuccess(endpoint, "參數已成功更新。");
//			}
//			catch (Exception ex)
//			{
//				Console.WriteLine($"處理請求時發生錯誤: {ex.Message}");
//				await RespondWithFailure(endpoint, $"內部錯誤: {ex.Message}");
//			}
//		}

//		private async Task RespondWithSuccess(AmqpCFXEndpoint endpoint, string message)
//		{
...
//			await Task.Run(() => endpoint.Publish(response));
//			Console.WriteLine($"成功響應: {message}");
//		}


//		// 失敗回應邏輯
//		private async Task RespondWithFailure(AmqpCFXEndpoint endpoint, string message)
//		{
//			var response = new ModifyStationParametersResponse
//			{
//				Result = new RequestResult
...
//			await Task.Run(() => endpoint.Publish(response));
//			Console.WriteLine($"失敗響應: {message}");
//		}
