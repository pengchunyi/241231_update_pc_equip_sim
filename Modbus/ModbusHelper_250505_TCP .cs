...
//		public static async Task SwitchON(string ipAddress, int port, byte stationNumber)
//		{
...
//				await networkStream.WriteAsync(openCommand, 0, openCommand.Length);
//			}
//			finally
//			{
//				tcpLock.Release();
...
//		/// 异步分闸
//		/// </summary>
//		public static async Task SwitchOFF(string ipAddress, int port, byte stationNumber)
//		{
//			await tcpLock.WaitAsync();
//			try{
//					if (tcpClient == null || !tcpClient.Connected)
...
//					await networkStream.WriteAsync(closeCommand, 0, closeCommand.Length);
