...
namespace AmqpModbusIntegration
{
	public static class UIInitializer
	{
		...
		public static void InitializeUI(
			...
			//250327新增=================================================
			//out TextBox CFXhandlerInputBox//新增設備cfx handler輸入框
			//250327新增=================================================
			)
		{
			...
			//250327新增===========================================
			//// 新增 AMQP Endpoint 名稱輸入框
			//var amqpEndpointLabel = new Label { Text = "AMQP Endpoint:", Location = new System.Drawing.Point(10, 90), AutoSize = true };
			//viewer.Controls.Add(amqpEndpointLabel);

			//CFXhandlerInputBox = new TextBox { Location = new System.Drawing.Point(100, 90), Width = 200 };
			//viewer.Controls.Add(CFXhandlerInputBox);
			//250327新增===========================================
