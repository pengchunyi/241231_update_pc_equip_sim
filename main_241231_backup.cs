...
//		// 添加方法：處理開關開啟/關閉的通用邏輯
//		//public void ExecuteSwitchCommand(Action<SerialPort, byte> switchCommand)
//		//{
...
//		//	try
//		//	{
//		//		// 呼叫 ModbusHelper 的溫度設置方法
//		//		ModbusHelper.SetTemperature(serialPort, stationNumber, temperature, slaveData);

//		//		// 更新 DataGridView 的顯示（如果需要）
//		//		UpdateDataGridView();

//		//		Console.WriteLine($"站號 {stationNumber} 的保護溫度已設置為: {temperature}°C");
//		//	}
//		//	catch (Exception ex)
//		//	{
//		//		Console.WriteLine($"設置站號 {stationNumber} 的溫度時出現錯誤: {ex.Message}");
//		//	}
//		//}
...
//						byte[] fullCommand = ModbusHelper.AppendCRC(command);
...
//						if (bytesRead > 5 && ModbusHelper.ValidateCRC(responseBuffer, bytesRead))
//						{
//							Console.WriteLine($"成功設置站號 {stationNumber} 溫度為 {temperature}°C");
//							slaveData[stationNumber]["溫度保護(℃)"] = temperature;
//						}
//						else
//						{
//							Console.WriteLine("無效回應或 CRC 校驗失敗");
//						}
//					}
//					catch (TimeoutException)
//					{
//						Console.WriteLine($"設置溫度超時，站號: {stationNumber}");
//					}
//					catch (Exception ex)
//					{
//						Console.WriteLine($"設置溫度失敗: {ex.Message}");
//					}
//				}
//			});
//		}
