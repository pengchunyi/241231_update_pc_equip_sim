...
////		// 使用泛型字典來存儲不同類型的數據
////		// Dictionary<byte, Dictionary<string, object>> 可以存儲任何類型的數據
...
////		//public int energy;
////		public double energy; // 使用 double 來儲存 energy
...
////        private Dictionary<byte, Dictionary<string, object>> slaveData = new Dictionary<byte, Dictionary<string, object>>();
...
//		public int switchStatus, apparentPowerA, apparentPowerB, apparentPowerC, totalApparentPower;
//		public int totalActivePower, totalReactivePower, combinedPowerFactor, lineFrequency, deviceType;
...
//			//下面這個是勁諺給的，也是sie上118顯示的
//			//amqpManager.StartAmqpEndpoint("CFX.A00.S056421215");
//			//下面這個是jianshan給的，也是MES上顯示最終的正確版
