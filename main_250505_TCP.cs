...
namespace AmqpModbusIntegration
{
	public class ModbusViewer : Form
	{
		...
		public ModbusViewer()
		{
			...
			{
				var ip = "192.168.1.200"; // 应从文本框获取实际值
				var port = 502;
				ModbusHelper.Connect(ip, port);
			};
	...
	ModbusHelper.SwitchON(ip, port, station));
			switchOffButton.Click += (s, e) => ExecuteSwitchCommand((ip, port, station) =>
	ModbusHelper.SwitchOFF(ip, port, station));
